...
from .models import  FriendNotification, JoinGroupNotification, State, Zipcode, Address,ParentEventNotice, AncestorGroupEvent
...
admin.site.register(ParentEventNotice)
admin.site.register(AncestorGroupEvent)
